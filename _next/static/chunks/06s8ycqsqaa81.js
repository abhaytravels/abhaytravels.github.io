(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,32036,e=>{"use strict";var r=e.i(1484);e.s(["formatDate",0,function(e,a){if(!e)return"";let l=e instanceof Date?e:new Date(e),i=r.siteConfig.locale?.language||"en-IN",t=r.siteConfig.locale?.timezone||"Asia/Kolkata";return l.toLocaleDateString(i,{timeZone:t,...a})},"formatNumber",0,function(e,a){if(null==e||isNaN(e))return"0";let l=r.siteConfig.locale?.language||"en-IN";return e.toLocaleString(l,a)}])},1687,e=>{"use strict";e.s(["permalinksConfig",0,{pages:"",vehicles:"vehicles",services:"services",routes:"routes",locations:"locations",blogs:"blog",media:"media",categories:"categories",tags:"tags",authors:"authors"}])},5802,e=>{"use strict";var r=e.i(43476),a=e.i(71645);e.s(["default",0,function({items:e,renderCard:l,searchPlaceholder:i="Search…",filterGroups:t=[],itemsPerPage:o=12,noResultsText:s="No results found. Try a different search or filter.",gridCols:c=3}){let[n,d]=(0,a.useState)(""),[m,g]=(0,a.useState)({}),[p,f]=(0,a.useState)(1),u=(0,a.useMemo)(()=>{let r=n.toLowerCase().trim();return e.filter(e=>{let a=!r||e.title.toLowerCase().includes(r)||(e.description||"").toLowerCase().includes(r)||(e.tag_slugs||"").toLowerCase().includes(r)||(e.category_slugs||"").toLowerCase().replace(/-/g," ").includes(r)||e.content&&"string"==typeof e.content&&e.content.toLowerCase().includes(r),l=t.every(r=>{let a=m[r.label];return!a||"all"===a||(r.getField(e)||"").split("|").map(e=>e.trim()).includes(a)});return a&&l})},[e,n,m,t]),h=Math.max(1,Math.ceil(u.length/o)),b=Math.min(p,h),x=u.slice((b-1)*o,b*o),v=(0,a.useCallback)(e=>{d(e),f(1)},[]),w=(0,a.useCallback)((e,r)=>{g(a=>({...a,[e]:r})),f(1)},[]),y=n||Object.values(m).some(e=>e&&"all"!==e),j=(0,a.useCallback)(()=>{d(""),g({}),f(1)},[]);return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)("div",{className:"lc-filter-bar",children:(0,r.jsxs)("div",{className:"container",children:[(0,r.jsxs)("div",{className:"lc-search-row",children:[(0,r.jsxs)("div",{className:"lc-search-wrap",children:[(0,r.jsx)("span",{className:"lc-search-icon","aria-hidden":"true",children:"🔍"}),(0,r.jsx)("input",{id:"listing-search",type:"search",placeholder:i,value:n,onChange:e=>v(e.target.value),"aria-label":i,className:"lc-search-input",autoComplete:"off"}),n&&(0,r.jsx)("button",{onClick:()=>v(""),className:"lc-search-clear","aria-label":"Clear search",children:"✕"})]}),y&&(0,r.jsx)("button",{onClick:j,className:"lc-clear-all-btn","aria-label":"Clear all filters",children:"✕ Clear all"})]}),t.map(e=>(0,r.jsxs)("div",{className:"lc-pill-row",role:"group","aria-label":`Filter by ${e.label}`,children:[(0,r.jsxs)("span",{className:"lc-pill-label",children:[e.label,":"]}),(0,r.jsxs)("div",{className:"lc-pills",children:[(0,r.jsx)("button",{onClick:()=>w(e.label,"all"),className:`lc-pill ${!m[e.label]||"all"===m[e.label]?"active":""}`,"aria-pressed":!m[e.label]||"all"===m[e.label],children:"All"}),e.values.map(a=>(0,r.jsx)("button",{onClick:()=>w(e.label,a),className:`lc-pill ${m[e.label]===a?"active":""}`,"aria-pressed":m[e.label]===a,children:e.labelMap?.[a]||a.replace(/-/g," ")},a))]})]},e.label))]})}),(0,r.jsx)("div",{className:"container lc-results-header",children:(0,r.jsx)("p",{className:"lc-results-count","aria-live":"polite",children:0===u.length?"No results":`Showing ${(b-1)*o+1}–${Math.min(b*o,u.length)} of ${u.length} result${1!==u.length?"s":""}`})}),(0,r.jsxs)("div",{className:"container lc-grid-wrap",children:[0===u.length?(0,r.jsxs)("div",{className:"lc-empty",children:[(0,r.jsx)("p",{style:{fontSize:"2.5rem",margin:"0 0 1rem"},children:"🔍"}),(0,r.jsx)("p",{style:{fontFamily:"var(--font-display)",fontWeight:"700",fontSize:"1.125rem",color:"var(--color-secondary)",marginBottom:"0.5rem"},children:"No results found"}),(0,r.jsx)("p",{style:{color:"var(--color-muted-fg)",marginBottom:"1.25rem",fontSize:"0.9375rem"},children:s}),(0,r.jsx)("button",{onClick:j,className:"lc-clear-all-btn",children:"✕ Clear filters"})]}):(0,r.jsx)("div",{className:`lc-grid ${2===c?"lc-grid-2":4===c?"lc-grid-4":"lc-grid-3"}`,children:x.map(e=>(0,r.jsx)("div",{children:l(e)},e.id))}),h>1&&(0,r.jsxs)("nav",{className:"lc-pagination","aria-label":"Page navigation",children:[(0,r.jsx)("button",{onClick:()=>f(e=>Math.max(1,e-1)),disabled:1===b,className:"lc-page-btn","aria-label":"Previous page",children:"← Prev"}),Array.from({length:h},(e,r)=>r+1).map(e=>(0,r.jsx)("button",{onClick:()=>f(e),className:`lc-page-btn ${b===e?"active":""}`,"aria-current":b===e?"page":void 0,children:e},e)),(0,r.jsx)("button",{onClick:()=>f(e=>Math.min(h,e+1)),disabled:b===h,className:"lc-page-btn","aria-label":"Next page",children:"Next →"})]})]}),(0,r.jsx)("style",{children:`
        /* ── Filter bar ── */
        .lc-filter-bar {
          background: #fff;
      ...
      `})]})}])},84048,e=>{"use strict";var r=e.i(43476),a=e.i(22016),l=e.i(5802),i=e.i(1687),t=e.i(1484),o=e.i(32036);function s({blog:e}){var l;let c=`/${i.permalinksConfig.blogs}/${e.slug}`,n=(l=e.created_at)?(0,o.formatDate)(l,{day:"numeric",month:"short",year:"numeric"}):null,d=e.tag_slugs?e.tag_slugs.split(",").slice(0,2):[];return(0,r.jsxs)("article",{className:"blog-card",itemScope:!0,itemType:"https://schema.org/BlogPosting",children:[(0,r.jsx)("meta",{itemProp:"headline",content:e.title}),e.created_at&&(0,r.jsx)("meta",{itemProp:"datePublished",content:e.created_at}),(0,r.jsx)("meta",{itemProp:"author",content:t.siteConfig.company.name}),(0,r.jsx)(a.default,{href:c,className:"blog-card-img-link",tabIndex:-1,"aria-hidden":"true",children:e.thumbnail_image?(0,r.jsx)("div",{className:"blog-card-img-wrap",children:(0,r.jsx)("img",{src:e.thumbnail_image,alt:`${e.title} — travel guide by ${t.siteConfig.company.name}`,className:"blog-card-img",loading:"lazy",width:600,height:338,itemProp:"image"})}):(0,r.jsx)("div",{className:"blog-card-placeholder",children:(0,r.jsx)("span",{children:"📝"})})}),(0,r.jsxs)("div",{className:"blog-card-body",children:[(0,r.jsxs)("div",{className:"blog-card-meta",children:[d.map(e=>(0,r.jsx)("span",{className:"blog-tag",children:e.replace(/-/g," ")},e)),n&&(0,r.jsx)("span",{className:"blog-date",itemProp:"datePublished",children:n})]}),(0,r.jsx)("h2",{className:"blog-card-title",children:(0,r.jsx)(a.default,{href:c,style:{color:"inherit",textDecoration:"none"},itemProp:"url",children:e.title})}),e.description&&(0,r.jsx)("p",{className:"blog-card-desc",itemProp:"description",children:e.description.length>110?e.description.slice(0,110)+"…":e.description}),(0,r.jsx)(a.default,{href:c,className:"blog-card-cta","aria-label":`Read full article: ${e.title}`,children:"Read Article →"})]})]})}e.s(["default",0,function({allBlogs:e,tags:a}){return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(l.default,{items:e,renderCard:e=>(0,r.jsx)(s,{blog:e}),searchPlaceholder:"Search articles — airport taxi, weekend trip, vehicle guide…",filterGroups:a.length>0?[{label:"Topic",values:a.slice(0,12),getField:e=>e.tag_slugs||""}]:[],itemsPerPage:9,gridCols:3,noResultsText:"Try searching 'airport', 'outstation', 'vehicle' or a destination name."}),(0,r.jsx)("style",{children:`
